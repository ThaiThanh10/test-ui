...
export const subjectsData = [
  {
    id: 1,
    name: "Ty le thuc hien ki thuat chuyen mon theo phan tuyen kham chua benh",
    khoa: "KHTH",
    period: "Quy",
    goal: ">60%",
    result: "70% ",
...
{
    id: 2,
    name: "Ty le phau thuat tu loai II tro len",
    khoa: "Gay me hoi suc",
    period: "Quy",
    goal: ">65%",
    result: "",
...
{
    id: 4,
    name: "Ty le nhiem khuan benh vien (viem phoi)",
    khoa: "KS Nhiem Khuan",
    period: "Quy",
    goal: ">5%",
    result: "18,8%",
...
{
    id: 5,
    name: "So su co y khoa nghiem trong",
    khoa: "QLCL",
    period: "6 thang",
    goal: "0",
    result: "0",
...
{
    id: 6,
    name: "So su co ngoai y khoa nghiem trong",
    khoa: "QLCL",
    period: "6 thang",
    goal: "0",
    result: "0",
...
{
    id: 7,
    name: " Thoi gian kham benh trung binh cua nguoi benh (phut)",
    khoa: "Khoa Kham & QLDT",
    period: "6 thang",
    goal: "<45 phut",
    result: "phut",
...
{
    id: 8,
    name: " Thoi gian nam benh trung binh cua nguoi benh (ngay)",
    khoa: "KHTH",
    period: "Quy",
    goal: ">14",
    result: "13 ngay",
...
{
    id: 9,
    name: "Cong suat su dung giuong benh thuc te (%)",
    khoa: "KHTH",
    period: "Quy",
    goal: "80-100%",
    result: "84.6%",
...
{
    id: 10,
    name: "Hieu suat su dung phong mo",
    khoa: "Gay me hoi suc",
    period: "Quy",
    goal: "80-100%",
    result: "",
...
{
    id: 11,
    name: "Ti le tu vong va tien luong tu vong gia dinh xin chia ve (tat ca cac benh) (%)",
    khoa: "KHTH",
    period: "Quy",
    goal: "<10%",
    result: "7.4%",
...
{
    id: 12,
    name: "Ti le chuyen len tuyen tren kham chua benh (Tat ca cac benh)",
    khoa: "KHTH",
    period: "6 thang",
    goal: "",
    result: "0",
...
{
    id: 13,
    name: "Ti le tai nan thuong tich do vat sac nhon",
    khoa: "P. Dieu duong",
    period: "6 thang",
    goal: "<10",
    result: "7.6%",
...
{
    id: 14,
    name: "Ti le tiem phong viem gan B trong nhan vien y te",
    khoa: "Y te co quan",
    period: "Quy",
    goal: ">20%",
    result: "50%",
...
{
    id: 15,
    name: "Ti le hai long cua nhan vien y te (%)",
    khoa: "P. Dieu duong",
    period: "6 thang",
    goal: ">80%",
    result: "85.86%",
...
{
    id: 16,
    name: "Ti le hai long cua nguoi benh voi dich vu kham chua benh (noi tru) (%)",
    khoa: "P. Dieu duong",
    period: "Quy",
    goal: ">90%",
    result: "95.23%",
...
{
    id: 17,
    name: "Ti le hai long cua nguoi benh voi dich vu kham chua benh (ngoai tru) (%)",
    khoa: "P. Dieu duong",
    period: "Quy",
    goal: ">90%",
    result: "96.25%",
